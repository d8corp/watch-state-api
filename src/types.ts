...
export type GetRequiredDataKeys <URL extends string> = URL extends `${infer Before}{${infer Field}}${infer After}`
  ? Field | GetRequiredDataKeys<After> | GetRequiredDataKeys<Before>
  : never
